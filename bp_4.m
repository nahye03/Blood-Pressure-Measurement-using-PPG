...
load bp_related\valsalva4_data.mat
...
sbp =[785,1790,2774,3802,4848,5905,6973,8041,9101,10167,11225,12293,13353,14434,15495];
sbp=bp(sbp');
...
%%
%DBP 구하기
dbp=[631,1642,2627,3642,4696,5757,6833,7895,8956,10021,11073,12160,13220,14307,15366];
dbp=bp(dbp');
...
SBP4 = sbp;
DBP4 = dbp;
feature_HR4 = feature_HR;
feature_AREA4 = feature_AREA;
feature_HEIGHT4 = feature_HEIGHT;
feature_WIDRH4 = feature_WIDRH;
feature_STT4 = feature_STT;

save('blood_pressure\tr_4','SBP4','DBP4','feature_HR4','feature_AREA4','feature_HEIGHT4','feature_WIDRH4','feature_STT4');
