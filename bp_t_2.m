...
load bp_related\rep_valsalva2_data.mat
figure;
...
sbp =[416,1577,2781,3865,5175,6419,7683];
sbp=bp(sbp');
...
%%
%DBP 구하기
dbp=[255,1428,2626,3717,5054,6311,7582];
dbp=bp(dbp');
...
p_pi=[697,1895,2973,4319,5582,6845,8133,9386];
p_pv=ppg(p_pi);
...
%ppg valley 찾기
v_pi = [399,1596,2726,3903,5149,6592,7838,9068];
v_pv=ppg(v_pi);
...
SBP7 = sbp;
DBP7 = dbp;
feature_HR7 = feature_HR;
feature_AREA7 = feature_AREA;
feature_HEIGHT7 = feature_HEIGHT;
feature_WIDRH7 = feature_WIDRH;
feature_STT7 = feature_STT;

save('blood_pressure\ts_2','SBP7','DBP7','feature_HR7','feature_AREA7','feature_HEIGHT7','feature_WIDRH7','feature_STT7');
